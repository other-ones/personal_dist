...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        save_caption_file=open(caption_path,'w')
    ...
    # ADDED
    eval_prompts=open(args.caption_path).readlines()
    eval_prompts=[item.strip().replace('<new1>',args.eval_prior_concept1) for item in eval_prompts]
    ...
    with torch.no_grad():
        for batch_idx in range(num_batches):
            ...
            #
    json.dump(caption_data,save_caption_file,indent=1)
    del pipeline
