...
from consts_v7 import NONVLIVING_INTERACTIONS_ACTIVE,SHAPES,CREATIVES
import shutil


if __name__=='__main__':
    dst_root='../../captions/prior'
    ...
    captions_pet_human_interactions=list(set(captions_pet_human_interactions))[:200]
    captions_pet_relations=list(set(captions_pet_relations))[:200]
    captions_pet_backgrounds=list(set(captions_pet_backgrounds))[:200]
    captions_pet_styles=list(set(captions_pet_styles))[:200]
    captions_pet_wearings=list(set(captions_pet_wearings))[:200]
    ...
    dst_path=os.path.join(dst_root,'captions_prior_pet.txt')
    ...
    # captions_pet_creatives=sorted(captions_pet_creatives)
