...
if __name__=='__main__':
    ...
    captions_nonliving_human_interactions=list(set(captions_nonliving_human_interactions))[:200]
    captions_nonliving_relations=list(set(captions_nonliving_relations))[:200]
    captions_nonliving_backgrounds=list(set(captions_nonliving_backgrounds))[:200]
    captions_nonliving_styles=list(set(captions_nonliving_styles))[:200]
    captions_nonliving_creatives=list(set(captions_nonliving_creatives))[:200]
    ...
    dst_path=os.path.join(dst_root,'captions_prior_nonliving.txt')
