...
--placeholder_token1='<dog6>' \
--train_prior_concept1='dog' \
--prompt='a picture of cute dog with blue house in the background' \
--dst_dir='attn_maps_t5/nonspecial'
