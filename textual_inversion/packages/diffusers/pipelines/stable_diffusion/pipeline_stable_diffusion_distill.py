...
class StableDiffusionPipelineDistill(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    r"""
    ...
    def _encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            if prompt_prior is not None:
                text_inputs_prior = self.tokenizer(
                    prompt_prior,
                    padding="max_length",
                    max_length=self.tokenizer.model_max_length,
                    truncation=True,
    ...
    def __call__(
        ...
        prompt_prior: Union[str, List[str]] = None,
