    ...
    for concept_idx,concept in enumerate(concepts):
        ...
        for exp_idx,exp in enumerate(exps):
            for distill in distill_list:
                ...
                exp_name+=f'_dist{distill_str}'
                output_dir=os.path.join('results_distill/db_results/{}/{}'.format(dir_name,concept))
                ...
                while True:
                    ...
                    print(f"SLEEP GENERATION\t{dir_name}\t{exp_name}\t{concept_idx+1}/{len(concepts)}")
                    time.sleep(10)
